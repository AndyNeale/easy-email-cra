...
import { Stack, TextStyle, useBlock } from 'packages/easy-email-editor';
import React, { useCallback } from 'react';

export interface AttributesPanelWrapperProps {
  style?: React.CSSProperties;
  extra?: React.ReactNode;
  children: React.ReactNode | React.ReactElement;
}

export const AttributesPanelWrapper: React.FC<
  AttributesPanelWrapperProps
> = props => {

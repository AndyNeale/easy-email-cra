...
import { Link } from 'packages/easy-email-extensions/AttributePanel/components/attributes/Link';
...
import { Stack, useEditorProps, useFocusIdx } from 'packages/easy-email-editor';
  ...
  return (
    <AttributesPanelWrapper style={{ padding: 0 }}>
      <CollapseWrapper defaultActiveKey={['0', '1', '2', '3', '4']}>
        ...
        <Collapse.Item name="2" header={t('Link')}>
          <Stack vertical spacing="tight">
            <Link />
          </Stack>
        </Collapse.Item>

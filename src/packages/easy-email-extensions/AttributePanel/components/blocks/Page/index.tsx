...
import { AddFont } from 'packages/easy-email-extensions/components/Form/AddFont';
    ...
    <AttributesPanelWrapper style={{ padding: 0 }}>
      <Stack.Item fill>
        <Collapse defaultActiveKey={['0', '1']}>
          <Collapse.Item name="0" header={t('Email Setting')}>
          ...
          <Collapse.Item name="1" header={t('Theme Setting')}>

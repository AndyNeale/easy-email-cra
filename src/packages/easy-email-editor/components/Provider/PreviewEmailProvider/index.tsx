...
import { useLazyState } from 'packages/easy-email-editor/hooks/useLazyState';
import { HtmlStringToPreviewReactNodes } from 'packages/easy-email-editor/utils/HtmlStringToPreviewReactNodes';
...
export const PreviewEmailProvider: React.FC<{
  ...
  useEffect(() => {
    const breakpoint = parseInt(lazyPageData.data.value.breakpoint || '0', 10);

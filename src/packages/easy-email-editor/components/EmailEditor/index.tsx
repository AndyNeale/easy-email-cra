import 'packages/easy-email-editor/assets/font/iconfont.scss';
import { TabPane, Tabs } from 'packages/easy-email-editor/components/UI/Tabs';
import {
...
import {
  EventManager,
  EventType,
} from 'packages/easy-email-editor/utils/EventManager';

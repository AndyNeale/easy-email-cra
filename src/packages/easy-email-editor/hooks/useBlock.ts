...
import { RecordContext } from 'packages/easy-email-editor/components/Provider/RecordProvider';
import { IEmailTemplate } from 'packages/easy-email-editor/typings';
import { scrollBlockEleIntoView } from 'packages/easy-email-editor/utils';
  ...
  const moveBlock = useCallback(
    (sourceIdx: string, destinationIdx: string) => {
      ...
      if (sourceParent === destinationParent) {
        ...
        nextFocusIdx = `${destinationParentIdx}.children.[${destinationParent.children.findIndex(

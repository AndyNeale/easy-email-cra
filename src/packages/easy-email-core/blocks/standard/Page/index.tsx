...
import { t } from 'packages/easy-email-core/utils/I18nManager';
import { generaMjmlMetaData } from 'packages/easy-email-core/utils/generaMjmlMetaData';
        ...
        {`
          ...
          <mj-head>
              ...
              ${value.fonts
                ?.filter(Boolean)
                .map(
                  item => `<mj-font name="${item.name}" href="${item.href}" />`
                )}
            <mj-attributes>
